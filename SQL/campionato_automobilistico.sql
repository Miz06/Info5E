...
use db_campionato_automobilistico;
...
create table db_campionato_automobilistico.piloti_partecipanti_gare( 
	id_pilota int,
...
create table db_campionato_automobilistico.case_partecipanti_gare( 
