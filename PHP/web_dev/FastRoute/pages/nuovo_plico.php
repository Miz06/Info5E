...
<form method="post" action="nuovo_plico.php">
    ...
    <br>
    <h4>Informazioni relative alla gestione del plico</h4><hr>
    ...
    <br>
    <br>
    <h4><label for="contatto_spedizione">Email dell'addetto alla spedizione</label></h4><hr>
    ...
    <br>
    <br>
    <h4><label for="sede">In quale sede verrà spedito il pacco?</label></h4><hr>
    ...
    <br>
    <br>
    <h4><label for="contatto_recapito">Email dell'addetto al recapito </label></h4><hr>
    <?php foreach ($contatti_personale as $contatto_personale) {
