...
$querySelectGenitore = "SELECT * FROM genitori WHERE nome=:nome AND cognome=:cognome AND username=:username";
...
?>
    ...
    <form action="genitore.php" method="post">
        <div class="container">
            <h4>Effettua il login come GENITORE:</h4><br>
