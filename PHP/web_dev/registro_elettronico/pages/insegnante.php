...
$querySelectInsegnante = "SELECT * FROM insegnanti WHERE nome=:nome AND cognome=:cognome AND username=:username";

if (isset($_POST['username']) && isset($_POST['password']) && isset($_POST['nome']) && isset($_POST['cognome'])) {
    try {
        $stm = $db->prepare($querySelectInsegnante);
...
?>
    ...
    <form action="insegnante.php" method="post">
        <div class="container">
            <h4>Effettua il login come INSEGNANTE:</h4><br>
