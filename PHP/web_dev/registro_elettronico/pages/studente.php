...
$querySelectStudente= "SELECT * FROM studenti WHERE nome=:nome AND cognome=:cognome AND username=:username";

if (isset($_POST['username']) && isset($_POST['password']) && isset($_POST['nome']) && isset($_POST['cognome'])) {
    try {
        $stm = $db->prepare($querySelectStudente);
...
?>
    ...
    <form action="studente.php" method="post">
        <div class="container">
            <h4>Effettua il login come STUDENTE:</h4><br>
