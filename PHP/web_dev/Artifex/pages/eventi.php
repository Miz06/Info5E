...
foreach ($visite as $v) {
    echo '<br><div class="container" style="background-color:darkslategray;">';
    echo '<h3 style="color: white;"><strong>' . $v['titolo'] . '</strong></h3><hr style="color:white;">';
    foreach ($eventi as $e) {
        if ($v['titolo'] == $e['titolo_visita']) {
            echo '<div class="container" style="background-color:whitesmoke;"> ';
            echo '<h5><strong>- Data:</strong> ' . $e['data'] . '</h5>';
            echo '<h5><strong>- Ora:</strong> ' . $e['ora_inizio'] . '</h5>';
